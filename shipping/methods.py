...
class HighTimeServing(Free):
    """
    6 to 15 days serving
    """ 
    code = 'in-30-days-serving'
    name = _('In 30 Days Serving')


class LessTimeServing(FixedPrice):
    """
    6 to 15 days serving
    """ 
    code = '6-to-15-days-serving'
    name = _('6 To 15 Days Serving')
    charge_excl_tax = 80
    charge_incl_tax = 80
